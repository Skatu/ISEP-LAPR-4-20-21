...
public class AppSettings {
    ...
    private void setDefaultProperties() {
        ...
        this.applicationProperties.setProperty(PERSISTENCE_UNIT_KEY, "eapli"
                + ".base");
        /* todo: definir os valores default */
        this.applicationProperties.setProperty(EMAIL_FROM, "");
        this.applicationProperties.setProperty(EMAIL_PASSWORD, "");
        this.applicationProperties.setProperty(EMAIL_HOST, "");
        this.applicationProperties.setProperty(EMAIL_PORT, "");
